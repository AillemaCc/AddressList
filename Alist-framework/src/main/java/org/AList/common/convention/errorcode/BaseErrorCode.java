...
public enum BaseErrorCode implements IErrorCode {
    ...
    TOKEN_REFRESH_INVALID("A0204","用户accessToken未过期,无需刷新"),
    ...
    MAJOR_ID_NAME_EMPTY("A0605", "专业编号或名称不能为空"),
    COLLEGE_ID_NAME_EMPTY("A0606", "学院编号或名称不能为空"),
    MAJOR_ID_EMPTY("A0607", "专业编号为空"),
    ...
    MAJOR_EXIST("A0624", "新增专业信息已存在"),
    MAJOR_BELONGING_COLLEGE("A0625", "专业已属于该学院"),
    UPDATE_MAJOR_BELONGED_COLLEGE_FAIL("A0626", "修改专业所属学院失败"),
    ...
    ANNOUNCE_DAILY_LIMIT("A0706","当日公告已达上限"),
    ...
    ADMIN_INFO_UNAVAILABLE("B0202", "系统无法获取当前管理员信息"),
